package net.rezxis.mchosting.spigot.gui.ranks;
...
public class DiamondRankItem extends GUIItem {

	private static int price = 40000;
	private static Rank rank = Rank.DIAMOND;
	
	public DiamondRankItem() {
		super(getIcon());
	}
	...
	public GUIAction invClick(InventoryClickEvent e) {
		...
		player.update();
		e.getWhoClicked().sendMessage(ChatColor.GREEN+"DIAMONDを購入しました。");
